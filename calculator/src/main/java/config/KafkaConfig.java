...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, CalculationRequest> calculationRequestConsumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, CalculationRequest.class.getName());
        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, CalculationRequest> calculationRequestListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, CalculationRequest> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(calculationRequestConsumerFactory());
        return factory;
    }
